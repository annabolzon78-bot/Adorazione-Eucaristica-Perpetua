...
const FALLBACK: Miracle[] = [
  { id:'1', title:'Lanciano', slug:'lanciano', location:'Lanciano', city:'Lanciano', state:'Abruzzo', continent:'EUROPA', year:750, yearCa:'VIII secolo d.C.', verificationLevel:'SCIENTIFICO', summary:'Il pane consacrato si trasformò in carne e il vino in sangue durante la Messa di un monaco basiliano dubbioso. Il più antico e studiato miracolo eucaristico del mondo.', scientificAnalysis:'Analisi del 1970 (Prof. Odoardo Linoli): tessuto muscolare cardiaco umano (miocardio del ventricolo sinistro), sangue tipo AB, struttura intatta dopo 12 secoli. 500 scienziati ONU: nessuna spiegazione naturale.', tissueType:'Miocardio — ventricolo sinistro', bloodType:'AB', analyzedBy:'Prof. Odoardo Linoli; OMS (500 scienziati)', analysisYear:1970, analysisInstitution:'Università di Siena; OMS', officialRecognition:'Riconosciuto dalla Chiesa dall\'VIII secolo', ecclesiasticalRecognition:'Conservato e venerato dal VIII secolo nella Basilica del Miracolo Eucaristico di Lanciano. Approvato da numerosi vescovi e da delegazioni pontificie nel corso dei secoli.', recognizedBy:'Vescovado di Lanciano; Delegazioni pontificie', isVisitableToday:true, visitingInfo:'Basilica del Miracolo Eucaristico, Lanciano (CH)', conservedAt:'Basilica del Miracolo Eucaristico, Lanciano', openingHours:'Mar-Dom 9:00-12:00, 16:00-19:00', imageUrl:'', thumbnailUrl:'', country:{ code:'IT', nameIt:'Italia', flagEmoji:'🇮🇹' }, images:[], videos:[], documents:[], bibliography:[ { id:'b1', authors:'Linoli O.', title:'Ricerche istologiche, immunologiche ed elettroforetiche del miracolo eucaristico di Lanciano', publisher:'Quaderni Sclavo di diagnostica', year:1971, type:'ARTICLE', journal:'Quaderni Sclavo', volume:'7', pages:'661–674' } ], pilgrimages:[ { id:'p1', name:'Pellegrinaggio a Lanciano', location:'Lanciano, Abruzzo, Italia', frequency:'Tutto l\'anno', organizer:'Frati Minori Conventuali' } ], viewCount:0, featuredOrder:1 },
  { id:'2', title:'Buenos Aires', slug:'buenos-aires', location:'Buenos Aires', city:'Buenos Aires', continent:'AMERICA_SUD', year:1996, yearCa:'1992, 1994, 1996', verificationLevel:'SCIENTIFICO', summary:'Tre episodi separati. Ostie cadute si trasformarono in carne sanguinante. Autorizzato da Bergoglio (futuro Papa Francesco). Al microscopio la carne era ancora viva.', scientificAnalysis:'Prof. Frederick Zugibe (cardiologo Columbia NY): miocardio del ventricolo sinistro, globuli bianchi vivi in movimento, sangue AB. DNA identico ai campioni di Lanciano a 800 anni di distanza.', tissueType:'Miocardio — ventricolo sinistro', bloodType:'AB', analyzedBy:'Prof. Frederick Zugibe', analysisYear:1999, analysisInstitution:'Columbia University, New York', officialRecognition:'Autorizzato dal Card. Bergoglio (futuro Papa Francesco)', ecclesiasticalRecognition:'Il Cardinal Jorge Mario Bergoglio, allora Arcivescovo di Buenos Aires, autorizzò personalmente le analisi scientifiche nel 1999. Documentato ufficialmente dall\'Arcidiocesi.', recognizedBy:'Card. Jorge Mario Bergoglio (poi Papa Francesco)', recognitionYear:1999, isVisitableToday:false, country:{ code:'AR', nameIt:'Argentina', flagEmoji:'🇦🇷' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:2 },
  { id:'3', title:'Sokółka', slug:'sokolka', location:'Sokółka', city:'Sokółka', state:'Podlaskie', continent:'EUROPA', year:2008, verificationLevel:'SCIENTIFICO', summary:'Ostia caduta messa in acqua si fusè con tessuto cardiaco. Impossibile separare il miocardio dal pane. "Non ho spiegazioni scientifiche." — Prof. Sulkowski.', scientificAnalysis:'Università di Białystok: miocardio strettamente intrecciato con il pane dell\'Ostia, impossibile separarlo. Sangue AB. Cuore in agonia.', tissueType:'Miocardio — fuso con il pane eucaristico', bloodType:'AB', analyzedBy:'Prof. Sulkowski; Università Medica di Białystok', analysisYear:2009, analysisInstitution:'Università Medica di Białystok', officialRecognition:'Dichiarato miracolo eucaristico dalla Conferenza Episcopale Polacca', ecclesiasticalRecognition:'Approvato dalla Conferenza Episcopale Polacca nel 2009. Conservato nella chiesa di Sant\'Antonio a Sokółka.', recognizedBy:'Conferenza Episcopale Polacca', recognitionYear:2009, isVisitableToday:true, conservedAt:'Chiesa di Sant\'Antonio, Sokółka', country:{ code:'PL', nameIt:'Polonia', flagEmoji:'🇵🇱' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:3 },
  { id:'4', title:'Siena', slug:'siena', location:'Siena', city:'Siena', state:'Toscana', continent:'EUROPA', year:1730, verificationLevel:'STORICO', summary:'348 Ostie rubate e ritrovate 3 giorni dopo. Ancora perfette e commestibili dopo quasi 300 anni. Nessun conservante.', scientificAnalysis:'Analisi 1914 e 2007: nessun agente conservante, pane ancora perfettamente commestibile dopo quasi 300 anni.', isVisitableToday:true, officialRecognition:'Conservate nella Basilica di San Francesco, Siena', conservedAt:'Basilica di San Francesco, Siena', country:{ code:'IT', nameIt:'Italia', flagEmoji:'🇮🇹' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[ { id:'p4', name:'Visita alle Sacre Particole', location:'Basilica di San Francesco, Siena', frequency:'Tutto l\'anno' } ], viewCount:0, featuredOrder:4 },
  { id:'5', title:'Santarém', slug:'santarem', location:'Santarém', city:'Santarém', continent:'EUROPA', year:1247, verificationLevel:'STORICO', summary:'Ostia portata via per strega cominciò a sanguinare. Il sangue è stato analizzato: sangue umano reale. Conservata da 777 anni.', isVisitableToday:true, conservedAt:'Chiesa di Santo Stefano, Santarém', country:{ code:'PT', nameIt:'Portogallo', flagEmoji:'🇵🇹' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:5 },
  { id:'6', title:'Tixtla', slug:'tixtla', location:'Tixtla', city:'Tixtla', state:'Guerrero', continent:'AMERICA_NORD', year:2006, verificationLevel:'SCIENTIFICO', summary:'Sangue rosso fuoriesce dall\'interno dell\'Ostia senza che nessuno la tocchi. Sangue AB, miocardio in agonia. Il più recente analizzato scientificamente.', tissueType:'Miocardio in agonia', bloodType:'AB', analyzedBy:'Instituto Politécnico Nacional, Messico', analysisYear:2007, country:{ code:'MX', nameIt:'Messico', flagEmoji:'🇲🇽' }, isVisitableToday:false, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:6 },
  { id:'7', title:'Bolsena', slug:'bolsena', location:'Bolsena', city:'Bolsena', state:'Lazio', continent:'EUROPA', year:1263, verificationLevel:'STORICO', summary:'Ostia sanguina durante la Messa di un prete dubbioso. Il Papa chiese a San Tommaso di scrivere il Corpus Domini. Il corporale è ancora a Orvieto.', officialRecognition:'Papa Urbano IV istituì il Corpus Domini', ecclesiasticalRecognition:'Papa Urbano IV commissionò a San Tommaso d\'Aquino la liturgia del Corpus Domini. Il corporale insanguinato è conservato nella Cattedrale di Orvieto, ancora venerato ogni anno durante la processione del Corpus Domini.', recognizedBy:'Papa Urbano IV', recognitionYear:1264, isVisitableToday:true, conservedAt:'Cattedrale di Orvieto (corporale)', country:{ code:'IT', nameIt:'Italia', flagEmoji:'🇮🇹' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[ { id:'p7', name:'Processione del Corpus Domini a Orvieto', location:'Orvieto, Umbria', frequency:'Annuale (Corpus Domini)' } ], viewCount:0, featuredOrder:7 },
  { id:'8', title:'Legnica', slug:'legnica', location:'Legnica', city:'Legnica', state:'Bassa Slesia', continent:'EUROPA', year:2013, verificationLevel:'SCIENTIFICO', summary:'Ostia caduta a Natale 2013. Due università analizzano senza sapere cosa sia. Cuore in agonia, sangue AB. Dichiarato miracolo nel 2016.', tissueType:'Miocardio in agonia', bloodType:'AB', analyzedBy:'Università di Medicina di Breslavia', analysisYear:2014, recognitionYear:2016, recognizedBy:'Vescovo Zbigniew Kiernikowski', country:{ code:'PL', nameIt:'Polonia', flagEmoji:'🇵🇱' }, isVisitableToday:true, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:8 },
  { id:'9', title:'Amsterdam', slug:'amsterdam', location:'Amsterdam', city:'Amsterdam', continent:'EUROPA', year:1345, verificationLevel:'STORICO', summary:'Ostia vomitata buttata nel fuoco resta intera. Tre tentativi falliti. Pellegrinaggio ancora oggi ogni anno (Stille Omgang).', isVisitableToday:true, visitingInfo:'Kapel ter Heilige Stede, Amsterdam', country:{ code:'NL', nameIt:'Olanda', flagEmoji:'🇳🇱' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[ { id:'p9', name:'Stille Omgang — Processione Silenziosa', location:'Amsterdam, Olanda', frequency:'Annuale (terza domenica di marzo)', organizer:'Gezelschap van den Heiligen Stede' } ], viewCount:0, featuredOrder:9 },
  { id:'10', title:'Chirattakonam', slug:'chirattakonam', location:'Chirattakonam', city:'Chirattakonam', state:'Kerala', continent:'ASIA', year:2001, verificationLevel:'STORICO', summary:'Sull\'Ostia appare il volto di Cristo sofferente. Lo vedono tutti. Fotografato. Nessuna manipolazione trovata. Avviene in India, paese non cristiano.', isVisitableToday:true, country:{ code:'IN', nameIt:'India', flagEmoji:'🇮🇳' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:10 },
  { id:'11', title:'Ferrara', slug:'ferrara', location:'Ferrara', city:'Ferrara', state:'Emilia-Romagna', continent:'EUROPA', year:1171, verificationLevel:'STORICO', summary:'L\'Ostia cade e sanguina davanti a tutta l\'assemblea. Il sangue schizza sui presenti. Centinaia di testimoni. Lettera a Papa Alessandro III.', country:{ code:'IT', nameIt:'Italia', flagEmoji:'🇮🇹' }, isVisitableToday:false, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:11 },
  { id:'12', title:'Offida', slug:'offida', location:'Offida', city:'Offida', state:'Marche', continent:'EUROPA', year:1280, verificationLevel:'STORICO', summary:'Ostia trasformata in carne sepolta poi dissotterrata intatta. Visitata da Giovanni Paolo II nel 2000. Ancora conservata.', isVisitableToday:true, conservedAt:'Basilica di Santa Maria della Rocca, Offida', country:{ code:'IT', nameIt:'Italia', flagEmoji:'🇮🇹' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:12 },
  { id:'13', title:'Walldürn', slug:'walldurn', location:'Walldürn', city:'Walldürn', state:'Baden-Württemberg', continent:'EUROPA', year:1330, verificationLevel:'STORICO', summary:'Sul panno macchiato di sangue appare il volto di Cristo con undici volti sanguinanti. 700 anni di pellegrinaggi. Centinaia di migliaia l\'anno.', isVisitableToday:true, conservedAt:'Basilica di San Giorgio, Walldürn', recognizedBy:'Papa Urbano V', country:{ code:'DE', nameIt:'Germania', flagEmoji:'🇩🇪' }, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[ { id:'p13', name:'Grande Pellegrinaggio di Walldürn', location:'Walldürn, Germania', frequency:'Annuale (settimana dopo Corpus Domini)', organizer:'Diocesi di Magonza' } ], viewCount:0, featuredOrder:13 },
  { id:'14', title:'Avignon', slug:'avignon', location:'Avignon', city:'Avignon', state:'Provenza', continent:'EUROPA', year:1433, verificationLevel:'STORICO', summary:'Ostie sott\'acqua per 33 giorni durante l\'inondazione del Rodano. Ritrovate perfette e galleggianti. Il pane si dissolve in minuti.', country:{ code:'FR', nameIt:'Francia', flagEmoji:'🇫🇷' }, isVisitableToday:false, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:14 },
  { id:'15', title:'Macerata Feltria', slug:'macerata-feltria', location:'Macerata Feltria', city:'Macerata Feltria', state:'Marche', continent:'EUROPA', year:1356, verificationLevel:'STORICO', summary:'Un contadino trova luce nei campi: un\'Ostia luminosa che galleggia nell\'aria. Sul posto fu costruita una cappella, meta di pellegrinaggio per secoli.', country:{ code:'IT', nameIt:'Italia', flagEmoji:'🇮🇹' }, isVisitableToday:true, images:[], videos:[], documents:[], bibliography:[], pilgrimages:[], viewCount:0, featuredOrder:15 },
]
